...
# ── Configuration ──────────────────────────────────────────────
VAULT_PATH = "D:/AIToutiao/knowledge-brain"
AGENT_MEMORY = "C:/Users/LHQ/.claude/projects/D--AIToutiao/memory"
SCANNER_DIR = os.path.dirname(os.path.abspath(__file__))
PYTHON = "C:/Users/LHQ/AppData/Local/Programs/Python/Python312/python.exe"
PROXY_HOST = "127.0.0.1"
PROXY_PORT = 7892

# Known project names (used for auto-detection from file paths)
PROJECT_KEYWORDS = {
    "aitoutiao": ["aitoutiao", "AITouTiao", "AIToutiao", "toutiao", "tou tiao", "今日头条"],
}
